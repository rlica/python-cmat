...
`python-cmat` is a modern, standalone Python toolkit for nuclear physics data analysis. It allows you to read, decompress, convert, and interactively navigate proprietary `.cmat` 2D coincidence matrices generated by the [GASPware](https://github.com/csteke/GASPware)/gsort acquisition and sorting suites—without requiring legacy 32-bit Fortran binaries or external C libraries.
